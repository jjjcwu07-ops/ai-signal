    ...
    const userMsg = `请为以下 Builder 的推文生成两部分内容，直接输出 JSON（不要 markdown 代码块）：
{
  ...
  "consulting": "你是一名顶级管理咨询顾问，服务过多家500强企业的AI转型项目。针对这条动态，从以下三个维度中选择最有洞见的一个角度，写2-3句话：\n【客户视角】这个动态会让你的企业客户产生什么新焦虑或新需求？他们下次开会会提这个吗？\n【项目视角】如果你正在交付一个AI战略或数字化转型项目，这个动态会改变你哪个具体的工作模块或交付物？\n【行业视角】这个信号预示着咨询行业的哪个具体工作会在12个月内被重新定义？\n\n写作要求：\n- 直接给出判断，不要铺垫，第一句就是核心观点\n- 用数字或具体场景让判断可信（比如'做尽调时''在战略规划第二阶段'）\n- 绝对禁止：值得关注/意义重大/带来机遇/面临挑战/赋能/加速/布局/不可忽视\n- 字数：80-120字"
}
...
[
  {
    ...
    "consulting": "你是顶级管理咨询顾问，针对这条国内AI动态，从以下角度选最有洞见的一个写2句话：①这会让你的企业客户产生什么新需求或新焦虑？②这改变了咨询顾问哪个具体交付模块？③12个月内哪个咨询工作会因此被重新定义？要求：第一句直接给判断，用具体场景或数字支撑，禁止：值得关注/带来机遇/面临挑战/赋能/加速，80字以内",
    "url": ""
  }
]`;
